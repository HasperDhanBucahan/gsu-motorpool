...
export default function RequestDetailModal({ isOpen, closeModal, request, userRole }) {
                        ...
                        <div className="space-y-6">
                            ...
                            {request.trip_ticket_number && (
                                <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
                                    <h4 className="text-lg font-semibold text-yellow-900 mb-4">Trip Ticket</h4>
                                    <div className="flex items-start space-x-3">
                                        <div className="w-10 h-10 bg-yellow-100 rounded-lg flex items-center justify-center flex-shrink-0">
                                            <FileText className="w-5 h-5 text-yellow-700" />
                                        </div>
                                        <div className="flex-1">
                                            <p className="text-sm text-yellow-700 mb-1">Ticket Number</p>
                                            <p className="font-bold text-yellow-900 text-2xl">#{request.trip_ticket_number}</p>
                                        </div>
                                    </div>
                                </div>
                            )}
