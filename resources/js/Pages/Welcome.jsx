    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-white text-gray-800 font-sans">
                    ...
                    <div className="max-w-7xl mx-auto px-6 py-4">
                        <div className="flex justify-between items-center">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h1 className="text-xl font-bold text-gray-900">GSU Motor Pool</h1>
                            ...
                            {/* Auth Button - UPDATED: Only Login */}
                            <div className="hidden md:flex items-center gap-3">
                                <Link
                                    href={route('login')}
                                    className="px-6 py-2.5 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-lg hover:from-orange-600 hover:to-orange-700 transition shadow-md hover:shadow-lg font-medium"
                                >
                                    Login
                                </Link>
                            </div>
                        ...
                        {/* Mobile Menu - UPDATED: Only Login */}
                        {mobileMenuOpen && (
                            <div className="md:hidden mt-4 pb-4 border-t border-gray-100 pt-4 animate-fade-in">
                                <div className="flex flex-col gap-3">
                                    ...
                                    <Link href={route('login')} className="px-4 py-2 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-lg text-center font-medium">Login</Link>
                                </div>
                            </div>
                        )}
                    </div>
                ...
                <section id="home" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-500 via-orange-600 to-red-600 text-white px-6 relative overflow-hidden pt-24">
                    ...
                    <div className="max-w-4xl mx-auto text-center relative z-10">
                        ...
                        <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full mb-8 border border-white/30">
                            ...
                            <span className="text-sm font-medium">General Services Unit Official System</span>
                        </div>
                        ...
                        <div className="mt-16 grid grid-cols-3 gap-8 max-w-2xl mx-auto">
                            <div className="text-center">
                                <div className="text-3xl md:text-4xl font-bold mb-1">Online</div>
                                <div className="text-sm text-white/80">Request Processing</div>
                            </div>
                            <div className="text-center">
                ...
                {/* Contact Section - UPDATED with Request Access Notice */}
                <section id="contact" className="py-24 px-6 bg-gradient-to-b from-gray-50 to-white">
                    <div className="max-w-4xl mx-auto">
                        ...
                        {/* NEW: Request Access Notice */}
                        <div className="mt-8 bg-gradient-to-br from-orange-500 to-red-600 rounded-xl p-6 text-white shadow-xl">
                            <div className="flex items-start gap-4">
                                ...
                                <div className="flex-1">
                                    <h3 className="font-bold text-lg mb-2">Need an Account?</h3>
                                    <p className="text-white/90 text-sm mb-3">
                                        To request access to the Motor Pool System, please send an email to the administrators with the following information:
                                    </p>
                                    ...
                                    <p className="text-sm text-white/90">
                                        Send to: <strong className="text-white">gsu@qsu.edu.ph</strong>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid md:grid-cols-3 gap-8 mb-8">
                            <div>
                                <div className="flex items-center gap-2 mb-4">
                                    ...
                                    <span className="font-bold text-lg">GSU Motor Pool</span>
                                </div>
                                <p className="text-gray-400 text-sm">
                                    Streamlining vehicle request management for General Services Unit
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <ul className="space-y-2 text-sm">
                                    ...
                                    <li><a href="#contact" className="text-gray-400 hover:text-white transition">Request Access</a></li>
                                </ul>
                            </div>
                        </div>

                        <div className="border-t border-gray-700 pt-8 text-center text-sm text-gray-400">
                            <p>&copy; {new Date().getFullYear()} General Services Unit Motor Pool System. All rights reserved.</p>
                        </div>
                    </div>
                </footer>
            </div>
